			...
			<Box className="flex flex-col justify-center items-center lg:flex-row gap:10 lg:gap-20 relative">
				...
				>
					<Box className="flex flex-col my-4 lg:my-0">
						...
						{/* <Box className="w-[140px] h-[140px] md:w-[200px] md:h-[200px] lg:w-[320px] lg:h-[320px] xl:w-[420px] xl:h-[420px] absolute bg-gradient-to-br from-gold-40 to-gold-1 z-0 right-[6%] top-[4%] md:top-[2%] lg:top-[6%] rounded-[20%]" /> */}

						<img
							alt="profile-pic"
							src={ProfilePic}
							className={`w-[140px] h-[140px] md:w-[200px] md:h-[200px] lg:w-[320px] lg:h-[320px] xl:w-[420px] xl:h-[420px] relative z-10 rounded-[20%] border-2 border-solid ${theme === "light" ? "border-black shadow-light" : "border-white shadow-dark"} `}
						/>
					</Box>
				</ScrollAnimation>
						...
						>
							...
							>
								<Typography sx={{ color: "text.secondary", padding: "1rem" }}>
									Well, I'm a Frontend Developer expert in creating top-tier
									user interfaces. With extensive experience in UI development
									and a keen eye for detail, I've made significant contributions
